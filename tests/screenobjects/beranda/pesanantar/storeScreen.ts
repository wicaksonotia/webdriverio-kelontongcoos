...
class StoreScreen extends AppScreen {
    ...
    async clickRokok () {
        ...
        await expect(this.cardProductRokok).toBeDisplayed();
        await this.cardProductRokok.click();
    }

    async clickMakanan () {
        await this.btnMakanan.click();
        await driver.pause(3000);
        await expect(this.cardProductMakanan).toBeDisplayed();
        await this.cardProductMakanan.click();
    }
    ...
    async seeCathegoryandProduct () {
        ...
        await Gestures.swipeUpCustom();
        await Gestures.swipeUpCustom();
        await Gestures.checkIfDisplayedWithSwipeUp(await this.cardProductLast, 50);
        ...
        await Gestures.swipeDownCustom();
        await Gestures.swipeDownCustom();
        await Gestures.checkIfDisplayedWithSwipeDown(await this.btnFavoritku, 50);
        // await expect(this.btnLainLain).toBeDisplayed();
        await driver.pause(3000);
    }
